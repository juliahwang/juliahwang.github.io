...
![프로젝트 가상환경 설정1](http://julihwang.github.io/images/2017-09-07/pycharm_setting_1.png)

<br>
 
아래 이미지를 참고하여 새로운 탭이 뜨면 아까 설정해준 `example_env`가 있는 경로를 찾아 OK 버튼을 누르면 된다. 

![프로젝트 가상환경 설정2](http://julihwang.github.io/images/2017-09-07/pycharm_setting_2.png)
...
![프로젝트 루트폴더 지정3](http://julihwang.github.io/images/2017-09-07/pycharm_setting_3.png)
